<template>
  <div>
    <!-- Promise Section -->
    <section id="promise" class="bg-white">
    ...
    <section class="bg-white">
      <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 px-4 py-3 md:py-4 gap-4">
        <div class="cols-span-1 lg:col-span-2 flex flex-col bg-slate-100 rounded-xl">
          <div class="bg-slate-200 rounded-lg w-full aspect-video relative overflow-hidden">
            <!-- Sử dụng iframe để nhúng video trực tiếp -->
            <iframe 
              width="100%" 
              height="100%" 
          ...
          <div class="flex-1">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-px bg-slate-100">
              <a v-for="(press, index) in pressReferences" :key="index" 
                 ...
                 class="flex gap-3 p-4 bg-white">
                <div class="flex-1">
                  <img class="h-5 w-auto" :src="press.logo" :alt="press.source" />
                  <h3 class="font-medium text-sm line-clamp-3 mt-2 hover:underline">
                    {{ press.title }}
                  </h3>
                </div>
                <div class="relative w-24 h-24 rounded-lg overflow-hidden bg-slate-200">
                  <img class="absolute aspect-square inset-0 object-cover" :src="press.image" :alt="press.title" />
                </div>
              </a>
            </div>
          </div>
    ...
    <section id="download" class="bg-primary">
      <div class="max-w-7xl mx-auto md:grid md:grid-cols-12">
        ...
        <div class="md:col-span-7 lg:col-span-8 relative overflow-hidden flex items-end justify-center">
          <img class="absolute top-0 lg:-top-1/2" width="734" height="734"
            src="https://cdn.youmed.vn/wp-content/themes/youmed/images/circle.svg" alt="Decor" />
          <div class="relative mx-auto">
            <img class="mx-auto" width="650" height="420"
              src="https://cdn.youmed.vn/wp-content/themes/youmed/images/app-download.svg" alt="iPhone" />
          </div>
        </div>
      </div>
    </section>
...
const pressReferences = [
  {
    source: 'Thanh Niên',
    logo: 'https://cdn.youmed.vn/tin-tuc/wp-content/uploads/2022/08/logo-bao-thanh-nien-scaled.jpg?width=60',
    title: 'Ứng dụng smartphone YouMed giúp đặt lịch khám bệnh',
    image: 'https://images2.thanhnien.vn/zoom/600_315/Uploaded/nthanhluan/2019_06_16/2_NERS.jpg',
    link: 'https://thanhnien.vn/ung-dung-smartphone-youmed-giup-dat-lich-kham-benh-185859083.htm'
  },
  {
    source: 'Sức khỏe đời sống',
    logo: 'https://static.mediacdn.vn/suckhoedoisong/image/logo.svg',
    title: '"Chuyển đổi số y tế - xu hướng không thể đi ngược trong thời đại 4.0"',
    image: 'https://suckhoedoisong.qltns.mediacdn.vn/thumb_w/640/324455921873985536/2022/5/16/1-1652672040175585266435.jpg',
    link: 'https://suckhoedoisong.vn/chuyen-doi-so-y-te-xu-huong-khong-the-di-nguoc-trong-thoi-dai-40-169220516103512466.htm'
  },
  {
    source: 'Bệnh viện Quân y 175',
    logo: 'https://cdn.youmed.vn/photos/186f542e-45e0-416b-9050-b258bfd2317b.png?width=60',
    title: 'Bệnh viện Quân y 175 ra mắt ứng dụng đặt khám trực tuyến',
    image: 'https://cdn.youmed.vn/wp-content/uploads/2023/05/bv-quan-y-175.jpg?width=120',
    link: 'https://bvranghammat.com/tin-tuc-thong-bao/benh-vien-rang-ham-mat-tphcm-phoi-hop-cung-youmed-trien-khai-dat-lich-online/'
  },
  {
    source: 'Y học cổ truyền',
    logo: 'https://cdn.youmed.vn/photos/fb4179f1-d0e9-4e2a-98a2-26e6efe7add8.png?width=40&height=40',
    title: 'Bệnh viện Y Học Cổ Truyền có mặt trên ứng dụng YouMed',
    image: 'https://cdn.youmed.vn/tin-tuc/wp-content/uploads/2021/08/leaflet-01-e1634787653628.png',
    link: 'https://www.yhct.vn/ChiTiet_BV.aspx?.=424'
  }
];
</script>
